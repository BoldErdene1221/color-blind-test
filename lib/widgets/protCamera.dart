...
class ProtCamera extends StatefulWidget {
  @override
  ProtCameraState createState() => ProtCameraState();
}

class ProtCameraState extends State<ProtCamera> with WidgetsBindingObserver {
