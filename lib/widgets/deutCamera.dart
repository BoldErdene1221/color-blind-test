...
class DeutCamera extends StatefulWidget {
  @override
  DeutCameraState createState() => DeutCameraState();
}

class DeutCameraState extends State<DeutCamera> with WidgetsBindingObserver {
